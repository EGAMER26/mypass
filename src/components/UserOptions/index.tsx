          ...
          <AnimatePresence>
            {open && (
              ...
              >
                <div>
                  {session ? (
                    menuItems.map(({ name, icon: Icon, onClick, submenu }) => (
                        ...
                        <Menu.Item>
                          {({ active }) => (
                            <button
                              ...
                              } flex w-full items-center px-4 py-2 text-sm text-white dark:text-gray-200 gap-2 transition rounded-md`}
                            >
                        ...
                        {submenu && (
                          <AnimatePresence>
                            {showAccessibility && (
                              ...
                              >
                                {submenu.map(
                                  ({ name: subName, icon: SubIcon, onClick, submenu }) => (
                                      ...
                                      <Menu.Item>
                                        {({ active }) => (
                                          <button
                                            ...
                                            className={`${
                                              active
                                                ? "bg-violet-200/20 dark:bg-violet-600/20"
                                                : ""
                                            } flex w-full items-center px-4 py-2 text-sm text-white dark:text-gray-200 gap-2 transition rounded-md`}
                                          >

...
export default function PasswordGenerator() {
  ...
  const [showPasswords, setShowPasswords] = useState<boolean | undefined>(false);
  const [showAddPasswords, setShowAddPasswords] = useState(false);
  const passwordsOpen = useSelector((state: ApplicationState) => state?.Modals.data.passwords);
  const {data: session} = useSession();
  const dispatch = useDispatch();

useEffect(() => {
  console.log('passwordsOpen', passwordsOpen)
      ...
      <main className="flex-grow container mx-auto mt-16 px-6 md:px-12 py-8 md:py-16">
        ...
        <div className="max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden mb-12 transition-colors duration-300">
          <div className="p-6 md:p-8">
            ...
            <button
            onClick={session ? () => setShowAddPasswords(true) : () => dispatch(updateModals({ login: true }))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md transition-colors duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Senhas complexas são muito mais difíceis de serem quebradas por
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md transition-colors duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Evite usar a mesma senha em vários sites. Nossa ferramenta gera
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              <p className="text-sm text-gray-600 dark:text-gray-400">
                &copy; {new Date().getFullYear()} SecurePass. Todos os direitos
                reservados.
              </p>
            </div>
